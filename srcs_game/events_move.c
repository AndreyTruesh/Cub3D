...
/*   Updated: 2020/09/25 20:59:41 by abibi            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if ((el->pos.pos_x - floor(el->pos.pos_x) < 0.05 && el->map.map[(int)el->
	pos.pos_y][(int)el->pos.pos_x - 1] == '1') || (1 - el->pos.pos_x +
	floor(el->pos.pos_x) < 0.05 && el->map.map[(int)el->pos.pos_y][(int)
	el->pos.pos_x + 1] == '1') || (el->pos.pos_y - floor(el->pos.pos_y)
	< 0.05 && el->map.map[(int)el->pos.pos_y - 1][(int)el->pos.pos_x] == '1')
	|| (1 - el->pos.pos_y + floor(el->pos.pos_y) < 0.05 && el->map.map[(int)
	el->pos.pos_y + 1][(int)el->pos.pos_x] == '1') || (el->pos.pos_y -
	floor(el->pos.pos_y) < 0.05 && el->pos.pos_x - floor(el->pos.pos_x) < 0.05
	&& el->map.map[(int)el->pos.pos_y - 1][(int)el->pos.pos_x - 1] == '1') ||
	(1 - el->pos.pos_y + floor(el->pos.pos_y) < 0.05 && 1 - el->pos.pos_x +
	floor(el->pos.pos_x) < 0.05 && el->map.map[(int)el->pos.pos_y + 1]
	[(int)el->pos.pos_x + 1] == '1'))
	{
